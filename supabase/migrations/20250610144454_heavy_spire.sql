/*
  # Fix alert status on response cancellation

  1. Database Functions
    - Update `decrement_responder_count` function to properly handle alert status
    - When responder_count reaches 0, change status from 'responded' back to 'active'
    - Maintain proper status transitions for alert lifecycle

  2. Security
    - Maintain existing function permissions
    - Ensure proper status validation
*/
